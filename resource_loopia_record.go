...
func resourceLoopiaRecordRead(d *schema.ResourceData, m interface{}) error {
    record, err := loopia.GetZoneRecord()
    if err != nil {
...
func resourceLoopiaeRecordImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
    ...
    record, err := loopia.GetZoneRecord(domain, subdomain, id)
